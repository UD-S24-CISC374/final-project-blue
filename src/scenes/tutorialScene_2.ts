...
export default class TutorialScene_2 extends Stage {
    constructor() {
        super("TutorialScene_2", 450, 150, 1, 3, 415, 285);
    ...
    create() {
        super.create();
        this.addTilesToGroup(0, 1, 1, 1);
        const tutText = this.add.text(
            this.cameras.main.width / 20,
            this.cameras.main.height / 4,
            'Try creating "False or True" to clear the board',
            {
                fontSize: "40px",
                color: "#000000",
                stroke: "#EAF2F8",
